        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Basic = table.Column<double>(type: "float", nullable: false, defaultValue: 0.0),
                    TAPercentage = table.Column<double>(type: "float", nullable: false, defaultValue: 0.0),
                    DAPercentage = table.Column<double>(type: "float", nullable: false, defaultValue: 0.0),
                    HRAPercentage = table.Column<double>(type: "float", nullable: false, defaultValue: 0.0),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "getdate()"),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "getdate()"),
                    LastUpdatedByUserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Designations_Name", x => x.Name);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_EmployeeTypes_Name", x => x.Name);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true, computedColumnSql: "[FirstName] + ' ' + [MiddleName] + ' ' + [LastName]"),
